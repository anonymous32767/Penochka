...
cd src
@ type header.js css.js base64.js jquery.min.js jquery.cookie.js jquery.form.js jquery.json.js storage.js jquery.imgboard.js settings.js  main.js >> penochka%ext%
cd ..
